...
The core issue wasn't a single bad query. It was the cumulative effect of reasonable decisions stacking together — and an unanswered systems design question: **where should the computation actually happen?**
