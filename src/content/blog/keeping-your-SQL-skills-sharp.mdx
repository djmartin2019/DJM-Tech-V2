...
readTime: 6
image: "practiceSQL.png"
author: "David Martin"
canonicalURL: "https://www.djm-tech.dev/blog/keeping-your-SQL-skills-sharp"
---
...
Each database comes with a complete schema plus realistic data you can load directly into PostgreSQL. Between the three, you'll have customers, invoices, movies, music, orders, and more, with plenty of tables to slice and dice.
...
4. **Document your learning**, and keep a notebook of interesting queries and techniques
...
Let me know what would be most useful, and I’d love to dig deeper in the next article.
