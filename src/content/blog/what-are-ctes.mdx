...
image: "SQL-CTE.png"
author: "David Martin"
canonicalURL: "https://www.djm-tech.dev/blog/what-are-ctes"
---
...
- Without the CTE, you'd be nesting aggregations inside aggregations, which is harder to read and debug.
...
Here, chaining CTEs makes the query flow logically: spend → ranked → filtered. Try writing this as one big query and it's a nightmare.
...
Looks tidy, but it didn't need a CTE since the main query is only one step. This is where restraint pays off.
