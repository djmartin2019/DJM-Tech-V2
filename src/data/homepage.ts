...
export const homepageProjects: HomepageProject[] = [
  ...
  },
  {
    ...
    title: "BirdBrain",
    description:
      "Bird species classifier trained on CUB-200-2011 with EfficientNet and ResNet50. SvelteKit frontend and FastAPI inference API for top-5 species predictions.",
    focus: [
    ...
    technologies: ["PyTorch", "FastAPI", "SvelteKit", "Docker"],
    href: "https://birdbrain.djm-apps.com/",
    githubUrl: "https://github.com/djmartin2019/BirdBrain",
    icon: "network",
  },
  {
    id: "edge-cache",
